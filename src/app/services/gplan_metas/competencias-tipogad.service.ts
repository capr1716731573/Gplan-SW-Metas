...
export class CompetenciasTipogadService {
  url:string=dominio_ws+'/competencia';
  tabla:string='Competencias TipoGAD';

  constructor(public http:HttpClient,
              public _settingsService:SettingsService) { }

  cargarDatos(pk_tipogad:number){
    let url_ws=`${this.url}/${pk_tipogad}`;
