...
export class SubmetasService {
  url:string=dominio_ws+'/submeta';
  tabla:string='Seguimiento';

  constructor(public http:HttpClient,
              public _settingsService:SettingsService) { }

  cargarDatos(pk_meta:number){
    let url_ws=`${this.url}/${pk_meta}`;
  ...
  crearSeguimiento(json:any):Observable<any>{
    let url_ws=`${this.url}/crear_seguimiento`;
